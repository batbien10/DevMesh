package devmesh.tui.dialog;

import devmesh.tui.Styles;
import devmesh.tui.tea.Style;
import devmesh.tui.tea.ANSI256Color;
 ...
 * It is driven by {@code DevMeshModel}, which calls {@link #handleKey(String)}
 * on every key press and {@link #render()} each frame.
 *
 * @see devmesh.tui.DevMeshModel
 */
public class PlanApprovalDialog {
    ...
    public String render() {
        ...
        sb.append(HEADER_STYLE.render(
                " DevMesh has written up a plan and is ready to execute. Would you like to proceed?"));
        sb.append("\n\n");
