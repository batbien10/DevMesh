...
public class SkillCatalog {
    ...
    public static SkillCatalog loadCatalog(String workDir) {
        ...
        if (home != null) {
            c.loadTier(Path.of(home, ".devmesh", "skills"), "user");
        }

        // Tier 3: project
        c.loadTier(Path.of(workDir, ".devmesh", "skills"), "project");
    ...
    private static List<String> skillDirPaths(String workDir) {
        ...
        String home = System.getProperty("user.home");
        if (home != null) {
            dirs.add(Path.of(home, ".devmesh", "skills").toString());
        }
        if (workDir != null) {
            dirs.add(Path.of(workDir, ".devmesh", "skills").toString());
        }
        return dirs;
    }
