 ...
 *   <li>User-level definitions from {@code ~/.devmesh/agents/*.md}</li>
 *   <li>Project-level definitions from {@code <projectRoot>/.devmesh/agents/*.md}</li>
 * </ol>
...
public final class AgentLoader {
    ...
    public static Map<String, SubAgentSpec> loadAll(Path projectRoot) {
        ...
        if (home != null && !home.isEmpty()) {
            loader.loadDir(Path.of(home, ".devmesh", "agents"));
        }

        if (projectRoot != null) {
            loader.loadDir(projectRoot.resolve(".devmesh").resolve("agents"));
        }
