...
public class HistoryStore {
    ...
    /** Default constructor &mdash; stores history in {@code ~/.devmesh/prompt_history.jsonl}. */
    public HistoryStore() {
        this(Path.of(System.getProperty("user.home"), ".devmesh", "prompt_history.jsonl"));
    }
